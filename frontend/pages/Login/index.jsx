...
import { LoginIcon } from "../../svg/LogSVG";
import LeftAuth from "../../component/authentication/LeftAuth";
import LoginFrm from "../../component/authentication/LoginFrm";
      ...
      <div className="relative overflow-hidden :">
        ...
        <div className="container  ">
          <div className="flex gap-x-6 h-screen justify-between items-center lg:mx-4 xl:mx-0">
            <div className="hidden lg:block lg:w-[47%] w-[45%] xl:w-[45%]">
              <LeftAuth
                tittle={"Login to access your Account"}
